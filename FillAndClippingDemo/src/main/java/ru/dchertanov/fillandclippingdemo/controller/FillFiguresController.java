...
public class FillFiguresController {
    ...
    protected void aboutButtonClick() {
        ...
        alert.setContentText("Выполнил: Чертанов Денис БПИ185.\n" +
                "Платформа: JavaFX.\n" +
                "Задание: 1) Вывод на экран окружностей, эллипсов, отрезков; " +
                "2) Реализовать алгоритм построчной заливки с затравочной точкой.\n" +
                ...
                "Для заливки необходимо в верхней части экрана выбрать цвет. " +
                "Затем нажать на кнопку \"Заливка построчно\" и поставить кликом затравочную точку.");
